...
public abstract class ViewModelModule {
    ...
    abstract ViewModel bindRepoViewModel(RepoViewModel searchViewModel);


    @Binds
    abstract ViewModelProvider.Factory bindRepoViewModelFactory(RepoViewModelFactory factory);
}
